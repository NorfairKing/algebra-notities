...
\begin{st}
  ...
  \begin{proof}
    ...
    \end{array}
    \]
    De derde gelijkheid geldt omdat de bewerking $*$ associatief is.\deref{de:groep} De vierde gelijkheid geldt omdat het neutraal element van een groep uniek is.\stref{st:neutraal-element-uniek}
  \end{proof}
\end{st}
