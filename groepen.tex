...
\begin{pr}
  ...
  \begin{proof}
    ...
    \item $\Leftarrow$\\
      ...
      $\nicefrac{G^{(k)}}{G^{(k-1)}}$ is immers commutatief{gev:afgeleide-door-groep-is-commutatief} en $G^{(k)}$ een normaaldeler van $G^{(k-1)}$.\stref{st:commutatordeelgroep-is-normaaldeler}
    \end{itemize}
  \end{proof}
\end{pr}
