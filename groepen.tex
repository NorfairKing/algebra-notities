...
\begin{de}
  ...
  Een (groeps)(homo)\term{morfisme} $f$ is een morfisme\deref{de:morfisme} tussen twee groepen $G,*$ en $H,\Box$.
...
\clarify{waarom? maak algoritme voor samenstelling van cykels en toon dan aan! Zie $(\alpha(i_{m,1})\dotsc\alpha(i_{m,j_{m}}))$ niet als (...) na $\alpha^{-1}$}
      ...
      \clarify{waarom? $\alpha$ is een permutate, dus zeker een bijectie}
...
\begin{st}
  ...
  \begin{proof}
    ...
    \item Beschouw de afbeelding $f$:
      ...
      $gH$ is dan gelijk aan $kH$ omdat $g$ en $H$ uit dezelfde nevenklasse komen. \clarify{nog meer uitleg nodig?}
