...
\begin{st}
  ...
  \begin{proof}
    ...
    \item associativiteit
      ...
      \TODO{ verwijzing naar vorig hoofdstuk zodra dit bewezen is. }
    \item neutraal element
      \[ \forall x \in Aut G: x \circ e = e = e \circ x \]
      Er bestaat een neutraal element voor $Aut G$, namelijk $Id_{G}$. 
      \TODO{ verwijzing naar vorig hoofdstuk. (ID verzameling)}
    \item inverse
...
\begin{st}
  ...
  \begin{proof}
    ...
    \item $\Rightarrow$\\
      ...
      Noem $\alpha^{-1}$ nu $\beta$, dan gelden $\beta \circ \alpha = Id_{G}$ en $\alpha \circ \beta = Id_{G}$ vanwege de definitie van de inverse van een afbeelding.
      \TODO{verwijzing naar inverse van een afbeelding.}
    \item $\Leftarrow$\\
      Zij $\alpha: G \rightarrow H$ $\beta: H \rightarrow G$ morfismes, zodat $\beta \circ \alpha = Id_{G}$ en $\alpha \circ \beta = Id_{G}$ gelden.
      Volgens de definitie van de inverse van een functie is $\beta$ de inverse van $\alpha$.
      \TODO{verwijzing naar inverse van een afbeelding.}
      Omdat $\alpha$ een inverse heeft, is $\alpha$ bijectief en bijgevolg een isomorfisme.
      \TODO{verwijzing naar E inverse asa bijectief.}
    \end{itemize}
  \end{proof}
\end{st}
...
\begin{st}
  Zij $x$ een element in een groep $G,*$, dan is de orde van de groep voortgebracht door $x$ gelijk aan de orde van $x$ in $G$.
  \[ |x| = |<x>| \]
...
\begin{de}
  Een groep $G,*$ is een \emph{cyclishe groep} als en slechts als er een element in $G$ bestaat dat de generator is van $G$. 
  We noemen bovendien $x$ de \emph{generator} van $G$.
\end{de}
...
\begin{st}
  Zij $G = <a>$ een cyclishe groep van orde $n$.
  De orde van $a^{k}$ is gelijk aan $m$:
  \[ m = \frac{n}{ggd(k,n)} \]
...
\begin{st}
  Elke deelgroep $H$ van een cyclische groep $G,* = <a>$ is cyclish.
  Sterker nog: $H$ wordt voortgebracht door $a^{s}$ waarbij $s \in \mathbb{N_{0}}$ het kleinste getal is waarvoor $a^{s} \in H$ geldt. 
...
\begin{ei}
  \label{ei:linker-neverklasse-eig}
  Zij $G$ een groep en $H$ een deelgroep van $G$.
...
\begin{ei}
  \label{ei:rechter-neverklasse-eig}
  Zij $G$ een groep en $H$ een deelgroep van $G$.
...
\begin{st}
  Zij $G$ een groep en $H$ een deelgroep van $G$, De linkse deelklassen van $H$ vormen een partitie van $G$.
...
\begin{gev}
  ...
  De orde van $x$ is een deler van $|G|$.
  \[ x^{|G|} = e_{G} \]
...
\begin{st}
  Zij $H$ een deelgroep van een groep $G,*$, dan vormen de linkernevenklassen van $H$ in $G$ een partitie van $G$.
  \begin{itemize}
  \item Elke linker neverklasse is niet-leeg.
  \item Elk element van $G$ behoort tot een linkernevenklasse.
  \item Twee rechter neverklassen zijn ofwel gelijk ofwel volledig disjunct.
  \end{itemize}
  Met andere woorden: De relatie ``x en y liggen in dezelfde linker nevenklasse van $H$ in $G$'' is een equivalentierelatie.

\TODO{ bewijs str}
\end{st}

\begin{st}
  Zij $H$ een deelgroep van een groep $G,*$, dan vormen de rechternevenklassen van $H$ in $G$ een partitie van $G$.
  \begin{itemize}
  \item Elke rechter neverklasse is niet-leeg.
  \item Elk element van $G$ behoort tot een rechternevenklasse.
  \item Twee rechter  neverklassen zijn ofwel gelijk ofwel volledig disjunct.
  \end{itemize}
  Met andere woorden: De relatie ``x en y liggen in dezelfde rechter nevenklasse van $H$ in $G$'' is een equivalentierelatie.
