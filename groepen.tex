...
\begin{ei}
  ...
  \[ \forall r,s \in \mathbb{Z}:\ (x^{s} = e \Leftrightarrow n | s) \wedge (x^{s} = e \Leftrightarrow n | r-s)\]
...
\begin{st}
  Zij $x$ een element in een groep $G,*$, dan is de orde van de groep voortgebracht door $x$ gelijk aan de orde van $G$.
  \[ |<x>| = |G| \]
...
\begin{de}
  ...
  \begin{itemize}
  \item De \emph{likse nevenklas} $xH$ van $H$ in $G$ bepaald door $x$:
    \[ xH = \{ x * h\ |\ h \in H \} \]
  \item De \emph{rechtse nevenklas} $Hx$ van $H$ in $G$ bepaald door $x$:
    \[ Hx = \{ h * x\ |\ h \in H \} \]
  \end{itemize}
\end{de}
