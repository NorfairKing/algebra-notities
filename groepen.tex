...
\begin{de}
  Een \emph{halfgroep} of \emph{mono\"ide} $G,*$ is een algebra\footnote{Zie definitie \ref{de:algebra}.} die bestaat uit een (niet-lege) verzameling $G$ en een overal bepaalde, interne afbeelding $*$ (De bewerking).
...
\begin{de}
  \label{de:groep}
  Een \emph{groep} $G,*$ is een mono\"ide waarvoor nog een extra voorwaarde geldt:\\
  Elk element $x \in G$ heeft een \emph{inverse} met betrekking tot de bewerking $*$: $x'$
...
\begin{de}
  Een \emph{commutatieve groep} of \emph{abelse groep} $G,*$ is een groep waarbij de bewerking $*$ commutatief is.
...
\begin{de}
  ...
  Een (groeps)(homo)\emph{morfisme} $f$ is een morfisme\footnote{Zie definitie \ref{de:morfisme}.} tussen twee groepen $G,*$ en $H,\Box$.
