...
\begin{st}
  ...
  \begin{proof}
    ...
    De vierde gelijkheid geldt omdat het neutraal element van een uniek is.\stref{st:neutraal-element-uniek}
  \end{proof}
\end{st}
...
\begin{st}
  ...
  \begin{proof}
    ...
    In de omgekeerde implicatie in de derde equivalentie maken we bovendien gebruik van het feit dat symmetrische elementen schrapbaar zijn.\stref{st:symmetrisch-element-schrapbaar}
  \end{proof}
\end{st}
