...
\question{geen echte oefeningen?}



\subsection{Oefening U}
...
\right\}
\ \text{ en }\ 
(X^{2}+X+1) = \left\{ r \cdot (X^{2}+X+1) \ |\ r \in \mathbb{Q}[X] \right\}
\]
\begin{itemize}
\item
  \[ -2X^{2}+I = \left\{ -2X^{2} + (r \cdot (X^{2}+X+1)) \ |\ r \in \mathbb{Q}[X] \right\}\]
\end{itemize}
\question{hoe??}
...
\extra{rest van de oefeningen van dit deel}
...
\question{hoe? einstein kan hier niet want $11$ is priem.}
