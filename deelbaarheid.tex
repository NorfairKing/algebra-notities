...
\begin{de}
  \label{de:deler}
  Zij $x$, $y$ elementen van $\mathbb{Z}$, dan is $x$ een \term{deler} van $y$ als er een $q$ in $\mathbb{Z}$ bestaat zodat $y = qz$ geldt.
...
\begin{de}
  Zij $a_{1},\dotsc,a_{n} \in \mathbb{Z}_{0}$. De \term{grootste gemene deler} $d$ van $a_{1},\dotsc,a_{n}$ is de het grootste getal $d \in \mathbb{N}$ waarvoor het volgende geldt:
...
\begin{de}
  ...
  $a_{1},\dotsc,a_{n}$ zijn \term{relatief priem} of \term{onderling ondeelbaar} als $ggd(a_{1},\dotsc,a_{n}) = 1$ geldt.
\end{de}

\begin{st}
  \label{st:euclidische-deling}
  \term{Euclidische deling}\\
...
\begin{de}
  Een \term{priemgetal} is een natuurlijk getal $p > 1$ dat alleen deelbaar is door $\pm 1$ en $\pm p$.
\end{de}
...
\begin{st}
  De unieke \term{priemfactorisatie}\\
