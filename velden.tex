...
\begin{st}
  ...
  \examen
  De \term{fundamentele stelling van de veldentheorie} of ook de \term{stelling van Kronecker}\\
...
\label{st:element-asa-uitbreiding-algebraisch}
  ...
  \begin{proof}
    ...
    \item $\Leftarrow$: De uitbreiding van $F$ tot $F(u)$ is eindig omdat $u$ algebra\"isch is over $F$\stref{st:uitbreiding-van-algebraische-u-aan-veld-graad-minimale-veelterm}, en bijgevolg algebra\"isch.\stref{st:uitbreiding-eindig-dan-algebraisch}
    \end{itemize}
  \end{proof}
\end{st}
...
\begin{st}
  ...
  \begin{proof}
    ...
    Als deelruimte van de eindigdimensionale vectorruimte $F(a)(b)$ is $F(a+b)$ ook eindigdimensionaal over $F,+,\cdot$. $F(a+b)$ is dus algebra\"isch over $F,+,\cdot$\stref{st:uitbreiding-eindig-dan-algebraisch}
