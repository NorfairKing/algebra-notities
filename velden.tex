...
\begin{st}
  ...
  \item Als $char(F)$ nul is, dan is het priemdeelveld van $F,+,\cdot$ isomorf met $\mathbb{Q}$.
  \end{itemize}
    ...
    \item Als $char(F)$ nul is, dan is $\phi$ een injectief ringmorfisme:
      ...
      \begin{array}{rll}
        \phi'(\nicefrac{a}{b} + \nicefrac{c}{d}) &=  \phi'\left(\frac{ad+bc}{bd}\right) &\\
                                                 ...
                                                 &= ((ad+bc)\cdot i) \cdot ((bd)\cdot i)^{-1} &\\
                                                 &= ((ad \cdot i) + (bc \cdot i)) \cdot ((bd)\cdot i)^{-1} &\\
                                                 &= ((ad \cdot i)\cdot ((bd)\cdot i)^{-1}) +  ((bc \cdot i) \cdot ((bd)\cdot i)^{-1}) &\\
                                                 &= \phi'(\nicefrac{ad}{bd}) + \phi'(\nicefrac{bc}{bd}) &= \phi'(\nicefrac{a}{b}) + \phi'(\nicefrac{c}{d}) \\
      \end{array}
      \]
      \[
      ...
      \begin{array}{rll}
        \phi'(\nicefrac{a}{b} \cdot \nicefrac{c}{d}) &= \phi'(\nicefrac{ac}{bd}) &\\
                                                     ...
                                                     &= (ac \cdot i) \cdot (bd \cdot i)^{-1} &\\
                                                     &= ((a \cdot i) \cdot (c \cdot i)) \cdot ((b \cdot i) \cdot (d \cdot i))^{-1} &\\
                                                     &= (a \cdot i) \cdot (b\cdot i)^{-1} \cdot (c \cdot i) \cdot (d \cdot i)^{-1} &\\
      ...
      geldt het volgende:
      \[ (a\cdot i) \cdot (b\cdot i)^{-1} = (c \cdot i) \cdot (d \cdot
      i)^{-1} \]
