...
\begin{st}
  ...
  Zij $u$ een eenheid in $R,+,\cdot$ en $I,+,\cdot$ een eenheid in $R,+,\cdot$.
...
\begin{st}
  ...
  \begin{proof}
    Inderdaad, voor elk ideaal $I$ dat $a$ omvat geldt het volgende;
    \[ \forall r \in R: a\cdot r \in I \wedge r \cdot a \in I \]
  \end{proof}
\end{st}
...
\begin{st}
  ...
  \begin{proof}
    ...
    \item $(ur) \subseteq (r)$\\
      ...
      \[ \forall y\in R:\ x \cdot u \cdot r \cdot y \in (ur) \]
    \item $(ur) \supseteq (r)$\\
    \end{itemize}
  \end{proof}
\question{hoe??}
...
\begin{st}
  Zij $R,+,\cdot$ een integriteitsdomein.
  Zij $r$ en $s$ elementen uit $R$.
  \[ (r) = (s) \Leftrightarrow (\exists u \in R^{\times}: s= u\cdot r) \]
\extra{bewijs}
\end{st}
...
\clarify{veel meer uitleg nodig!!}
