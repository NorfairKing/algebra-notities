...
\begin{st}
  ...
  $I,+,\cdot$ is een ideaal als aan \'e\'en van de volgende criteria voldaan is.
  \begin{itemize}
  ...
  \item $\forall x,y \in I,\ \forall r\in R:\ x-y\in I\ \wedge\ \quad \quad \quad \quad\   r\cdot x\in I\ \wedge\ x\cdot r \in I$ en $R,+,\cdot$ heeft een eenheidselement.
  \end{itemize}
\TODO{bewijs p 51}
\end{st}
