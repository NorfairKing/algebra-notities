...
\begin{de}
  Zij $R,+,\cdot$ een ring, dan noemen we een element $x$, verschillend van het nulelement, een \term{nuldeler} als er nog een element $y$, ook verschillend van het nulelement, bestaat zodat het volgende geldt:
  \[ x \cdot y = 0 \text{ of } y \cdot x = 0 \]
\end{de}
